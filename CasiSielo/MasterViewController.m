...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDateFormatter *subTitleFormatter = [[NSDateFormatter alloc]init];
    [subTitleFormatter setTimeStyle:NSDateFormatterMediumStyle];
    [subTitleFormatter setDateStyle:NSDateFormatterNoStyle];
    
    NSDate *myDate = [object valueForKey:@"timeStamp"];
    
    cell.textLabel.text = [formatter stringFromDate:myDate];
    cell.detailTextLabel.text = [subTitleFormatter stringFromDate:myDate];
...
- (void)updateTitle {
    ...
    int coffeeCount = [sectionInfo numberOfObjects];
    
    NSString *title = [[NSString alloc]initWithFormat:@"Coffees Brewed: %i", coffeeCount];
...
//    [self.navigationController popToViewController:previousController animated:YES];
    ...
    // NSLog(@"Save method called in App Delegate");
